            ...
            <Card>
                <CardHeader className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-muted-foreground text-sm">Role: {userData.role}</p>
                        {userData.phone && <p className="text-muted-foreground text-sm">Phone: {userData.phone}</p>}
                        {userData.area && <p className="text-muted-foreground text-sm">Area: {userData.area}</p>}
